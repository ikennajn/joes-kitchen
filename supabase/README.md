...
2. `20260817000150_index_households_created_by.sql` adds the covering index required by the household owner foreign key.
3. `20260817000200_enforce_authenticated_access.sql` refuses to run until an owner exists, then removes anonymous table access, enforces household ownership, and makes receipt/item-photo storage private.
